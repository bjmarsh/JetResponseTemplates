...
void JRTTree::Init(TTree *tree){
    if(tree == NULL){
        ...
        b_Flag_badMuonFilterV2                    = this->tree->Branch("Flag_badMuonFilterV2", &Flag_badMuonFilterV2);
        b_Flag_badMuonFilterV2_loose              = this->tree->Branch("Flag_badMuonFilterV2_loose", &Flag_badMuonFilterV2_loose);
        b_Flag_badChargedCandidateFilterV2        = this->tree->Branch("Flag_badChargedCandidateFilterV2", &Flag_badChargedCandidateFilterV2);
        ...
        this->tree->SetBranchAddress("Flag_badMuonFilterV2", &Flag_badMuonFilterV2, &b_Flag_badMuonFilterV2);
        this->tree->SetBranchAddress("Flag_badMuonFilterV2_loose", &Flag_badMuonFilterV2_loose, &b_Flag_badMuonFilterV2_loose);
        this->tree->SetBranchAddress("Flag_badChargedCandidateFilterV2", &Flag_badChargedCandidateFilterV2, &b_Flag_badChargedCandidateFilterV2);
...
void JRTTree::Reset(){
    ...
    evt_lumi = -1;
    evt_event = -1;
    Flag_badMuonFilterV2 = 1;
    Flag_badMuonFilterV2_loose = 1;
