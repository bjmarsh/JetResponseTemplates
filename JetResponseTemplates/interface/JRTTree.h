...
class JRTTree {
 public:
    ...
    int               evt_lumi;
    ULong64_t         evt_event;
    bool              Flag_badMuonFilterV2;
    bool              Flag_badMuonFilterV2_loose;
    bool              Flag_badChargedCandidateFilterV2;
 ...
 private:
    ...
    TBranch *b_Flag_badMuonFilterV2 = 0;
    TBranch *b_Flag_badMuonFilterV2_loose = 0;
    TBranch *b_Flag_badChargedCandidateFilterV2 = 0;
